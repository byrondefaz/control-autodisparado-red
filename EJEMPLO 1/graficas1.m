...
legend('Trayectoria','S','Smax','Smin','x(0)','Actualizaciones de control','FontSize', 10)%,'hmax','hmax*','Max x1','Min x1','Max x2','Min x2')
axis([-1.2,1.2,-1.2,1.2]);
set(gca,'XTick',[-1:0.2:1],'YTick',[-1:0.2:1],'FontSize',15)
xlabel('x_1','FontSize', 25),ylabel('x_2','FontSize', 25);
title('K=[1 1], |u|=1, h=0.25, x(0)=[-0.45  0.2]')
grid off
subplot(2,2,2)
...
set(gca,'FontSize',15)
title('Intervalos de muestreo','FontSize', 15)
hold on
